...
import { HasDescription, HasEmbed, HasMigrations, HasPublication, HasSlug, HasTraits } from "@module/data/index.ts";
 ...
 */
export default abstract class EffectSystem extends HasEmbed(HasTraits(HasMigrations(HasDescription(HasPublication(HasSlug(foundry.abstract.TypeDataModel))))), "effect-item") {
    /**
     * @internal
     */
