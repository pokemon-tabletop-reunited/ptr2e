...
export default class AbilitySystem extends HasEmbed(HasBase(foundry.abstract.TypeDataModel), "ability")<AbilitySchema, Item.ConfiguredInstance> {
  ...
  override async _preCreate(data: foundry.abstract.TypeDataModel.ParentAssignmentType<AbilitySchema, Item.ConfiguredInstance>, options: foundry.abstract.Document.PreCreateOptions<any>, user: foundry.documents.BaseUser): Promise<boolean | void> {
