...
export default class SpeciesSheet extends ItemSheetPTR2e<AnyObject> {
  ...
  static override PARTS: Record<string, foundry.applications.api.HandlebarsApplicationMixin.HandlebarsTemplatePart> = R.omit(
        ...
        element.addEventListener("click", async (event) => {
          ...
          switch (action) {
            case "add": {
              ...
              if (field === "movement") {
                const movementArr = foundry.utils.deepClone(
