...
import type { AnyObject, GetDataReturnType } from "fvtt-types/utils";

export default class PTUSheet extends DocumentSheet<DocumentSheetOptions<PTUActor>, PTUActor> {
  ...
  override async getData(
    option?: Partial<DocumentSheetOptions<PTUActor>> | undefined
  ): Promise<GetDataReturnType<DocumentSheet.DocumentSheetData<DocumentSheetOptions<PTUActor>, PTUActor>>> {
  ...
  protected override async _onSubmit(
    ...
    // @ts-expect-error - Intended override
    return false;
  }
}