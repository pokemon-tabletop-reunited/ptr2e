  ...
  static override defineSchema(recursion = 0): foundry.data.fields.DataSchema {
    ...
    return {
      ...
      shiny: new fields.NumberField({
        ...
        initial: () => {
          if(game?.settings) {
            return game.settings.get("ptr2e", "blueprint.shiny") ?? 1;
          }
          return 1;
        },
        nullable: false,
      ...
      level: new fields.StringField({
        ...
        initial: () => {
          if(game?.settings) {
            return game.settings.get("ptr2e", "blueprint.level") || null;
          }
          return null;
        }, 
        nullable: true, 
      ...
      nature: new fields.StringField({
        required: true, initial: () => {
          if(game?.settings) {
            return game.settings.get("ptr2e", "blueprint.nature") || null;
          }
          return null;
      ...
      gender: new fields.StringField({
        required: true, initial: () => {
          if(game?.settings) {
            return game.settings.get("ptr2e", "blueprint.gender") || null;
          }
          return null;
      ...
      _config: new fields.EmbeddedDataField(GeneratorConfig, { required: true, nullable: true, initial: () => {
        if(game?.settings) {
          const setting = game.settings.get("ptr2e", "blueprint.perk") || null;
