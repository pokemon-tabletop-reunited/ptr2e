...
class ActorPTR2e extends Actor {
  ...
  // override async _preCreate(data: foundry.data.fields.SchemaField.AssignmentType<Actor.Schema>, options: foundry.abstract.Document.PreCreateOptions<any>, user: User.ConfiguredInstance): Promise<boolean | void> {
