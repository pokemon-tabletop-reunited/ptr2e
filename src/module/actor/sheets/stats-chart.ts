...
export class StatsChart {
  sheet: ActorSheetPTR2e | foundry.applications.api.DocumentSheetV2<Actor.ConfiguredInstance, AnyObject>;
  ...
  constructor(sheet: ActorSheetPTR2e | foundry.applications.api.DocumentSheetV2<Actor.ConfiguredInstance, AnyObject>, options: Partial<ChartOptions> = {}, { id, cssclass }: { id?: string, cssclass: string } = { cssclass: "stats-chart" }) {
    this.sheet = sheet;
