...
export class RestApp extends foundry.applications.api.HandlebarsApplicationMixin(ApplicationV2Expanded)<AnyObject> {
  ...
  static async #onSubmit(
    ...
    const data = foundry.utils.expandObject(formData.object) as { restType: string; fractionToHeal: string };
    const healOptions = {
      fractionToHeal: 1.0,
      removeWeary: true,
      removeExposed: false,
