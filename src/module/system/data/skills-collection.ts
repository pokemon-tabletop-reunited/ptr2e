import { formatSlug, sluggify } from "../util/misc";
import type { CoreSkill, CustomSkill, Skill } from "./models/skill";

export default class SkillsCollection extends Collection<Skill> {
  ...
  static create() {
    return new SkillsCollection().refresh();
  }
