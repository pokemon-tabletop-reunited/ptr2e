...
export default class BasicChangeSystem extends ChangeModel {
   ...
   * @private
   */
  _parseOrString(raw: string): unknown {
    try {
   ...
   */
  static getNewValue(mode: 0 | 1 | 2 | 3 | 4 | 5 | 6, current: number, change: number, merge?: boolean): number;
  static getNewValue<TCurrent>(mode: 0 | 1 | 2 | 3 | 4 | 5 | 6, current: TCurrent, change: TCurrent extends (infer TValue)[] ? TValue : TCurrent, merge?: boolean): (TCurrent extends (infer TValue)[] ? TValue : TCurrent) | foundry.data.validation.DataModelValidationFailure;
  static getNewValue(mode: 0 | 1 | 2 | 3 | 4 | 5 | 6, current: unknown, change: unknown, merge?: boolean): unknown {
