...
const BaseSkillGroups = {
    "arts-group": { slug: "arts-group", points: 19 },
    "athletics-group": { slug: "athletics-group", points: 19 },
    "social-group": { slug: "social-group", points: 19 },
    "practical-group": { slug: "practical-group", points: 19 },
    "wilderness-group": { slug: "wilderness-group", points: 19 },
    "technology-group": { slug: "technology-group", points: 19 },
    "occult-group": { slug: "occult-group", points: 19 },
    "performance-group": { slug: "performance-group", points: 19 },
    "pilot-group": { slug: "pilot-group", points: 19 },
    "cars-group": { slug: "cars-group", parentGroup: "pilot", points: 20 },
    "aircraft-group": { slug: "aircraft-group", parentGroup: "pilot", points: 20 },
    "science-group": { slug: "science-group", points: 19 },
